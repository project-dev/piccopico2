...
<html lang="ja">
    <head>
        ...
        <script src="./script/png/pako.js?=<?php  ?>"></script>
        
        <script src="./script/png/png.js?=<?php  ?>"></script>
        <script src="./script/png/pngutil.js?=<?php  ?>"></script>

        <script src="./script/dgl.devel.js?=<?php  ?>"></script>
        <script src="./script/dgl.device.js?=<?php  ?>"></script>
        <script src="./script/dgl.audio.js?=<?php  ?>"></script>
        <script src="./script/dgl.core.js?=<?php  ?>"></script>

        <script src="./script/palette/palette_title.js?=<?php  ?>"></script>
        <script src="./script/palette/palette_demo.js?=<?php  ?>"></script>

        <script src="./script/scene_ready.js?=<?php  ?>"></script>
        <script src="./script/scene_title.js?=<?php  ?>"></script>
        <script src="./script/scene_demo.js?=<?php  ?>"></script>
        <script src="./script/scene_main.js?=<?php  ?>"></script>
        <script>
    		'use strict';
            LOG.isDebug = false;
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                try{
                    ...
                    // イメージのロード。非同期で読み込む
                    Promise.all([
                        loadPng("./img/music_mode_bg.png?=<?php  ?>"),
                        loadPng("./img/images01.png?=<?php  ?>"),
                        loadPng("./img/demo_song.png?=<?php  ?>"),
                        loadPng("./img/demo_song2.png?=<?php  ?>"),
                        loadPng("./img/demo_song3.png?=<?php  ?>"),
                        loadPng("./img/demo_bg_1.png?=<?php  ?>"),
